...
threshold_type: CV_THRESH_BINARY_INV; CV_THRESH_BINARY ;  
...
loadImage: does [
	...
	if not none? temp [
		...
		if error? try [
			...
			igray: cvCreateImage srcS/width srcS/height IPL_DEPTH_8U 1
			cvCvtColor src igray CV_BGR2GRAY
			iat: cvCreateImage srcS/width srcS/height IPL_DEPTH_8U 1
