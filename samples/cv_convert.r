...
imgStruct: getPointerValues src IplImage!

; for test in grayscale
gray: cvCreateImage imgStruct/width imgStruct/height IPL_DEPTH_8U 1
;to transform to 32-bit image
dst: cvCreateImage imgStruct/width imgStruct/height IPL_DEPTH_32F 3
dst2: cvCreateImage imgStruct/width imgStruct/height IPL_DEPTH_8U 3
