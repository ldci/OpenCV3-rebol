...
ipl: getIPLImage src  ; get structure content of src image 

clone: cvCreateImage ipl/width ipl/height ipl/depth ipl/nChannels ;IPL_DEPTH_8U 1;
sum:  cvCreateImage ipl/width ipl/height ipl/depth ipl/nChannels;IPL_DEPTH_8U 1;
...
; cvRelease... can be also used by require double pointer 
free-mem src 
free-mem clone 
free-mem ipl
free-mem sum
