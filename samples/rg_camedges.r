...
activateCam: does [
	...
	cedge: cvCreateImage imageS/width imageS/height IPL_DEPTH_8U 3
	;/ Convert to grayscale
    gray: cvCreateImage imageS/width imageS/height IPL_DEPTH_8U 1
    edge: cvCreateImage imageS/width imageS/height IPL_DEPTH_8U 1
...
quitCam: does [
	if isFile [
		free-mem image free-mem cedge
		free-mem gray  free-mem edge 
		freeDylib
	] 
	quit
]
...
display "OpenCV Tests: Camera Canny Detector" mainWin
do-events